...
void RadField::Beamed(const long int igrid, const double NH, 
  ...
  /*photo-reactions*/
	for (int i=0; i<NL99p::n_ph_; i++) {
		Gph[igrid][i] = (G0_/2.) * exp( -NL99p::kph_avfac_[i] * AV );
	}
